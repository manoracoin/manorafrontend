...
export const PaginationLast = ({ className, ...props }: IconLinkProps) => (
  <a aria-label="Go to last page" className={cn(buttonVariants({ variant: 'ghost', size: 'icon' }), baseIconClasses, className)} {...props}>
