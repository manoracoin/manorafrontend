...
const mnrTransactions: MnrTx[] = [
  ...
  { id: 'mnr_2002', type: 'sell', amountMnr: 100, amountUsd: 250, from: 'Manora Wallet', to: 'Fiat Wallet', timestamp: '2024-03-18T10:00:00', status: 'success' },
  { id: 'mnr_2003', type: 're_token_buy', amountMnr: 50, from: 'Manora Wallet', to: 'Buy RE Token (WRFMI)', timestamp: '2024-03-19T09:30:00', status: 'success' },
  { id: 'mnr_2004', type: 're_token_sell', amountMnr: 20, from: 'Sell RE Token (MOCSF)', to: 'Manora Wallet', timestamp: '2024-03-20T15:20:00', status: 'success' },
]

export default function ManoraTransactionsPage() {
  ...
  const filtered = React.useMemo(() => {
    ...
    return mnrTransactions.filter(tx =>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3 justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl sm:text-3xl font-semibold sm:font-bold tracking-tight">Manora Transactions</h2>
        </div>
        <div className="hidden sm:flex items-center gap-2">
          ...
          <Select value={type} onValueChange={setType}>
            ...
            <SelectContent>
              ...
              <SelectItem value="re_token_buy">Buy RE Token</SelectItem>
              <SelectItem value="re_token_sell">Sell RE Token</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <Card className="p-0 sm:p-6 border-0 rounded-none bg-transparent sm:border sm:rounded-lg sm:bg-card">
        <div className="hidden sm:grid grid-cols-[1.2fr_1fr_1fr_1fr_0.7fr_0.7fr] px-3 py-2 text-xs uppercase text-muted-foreground">
          <span>Tx</span>
          <span>Time</span>
          <span>From</span>
          <span>To</span>
        ...
        <div className="space-y-2">
          {paginated.map((tx) => (
            <div key={tx.id} className="p-3 rounded-lg border bg-card/50">
              <div className="hidden sm:grid items-center grid-cols-[1.2fr_1fr_1fr_1fr_0.7fr_0.7fr] gap-2">
                ...
                <div className="text-sm">{tx.amountMnr.toLocaleString()} MNR{tx.amountUsd?` ($${tx.amountUsd.toLocaleString()})`:''}</div>
              </div>
